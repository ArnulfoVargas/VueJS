<script setup>
    ...
    defineEmits(["on-add", "on-remove", "on-add-to-cart", "on-delete", "on-empty-cart"]);
                    ...
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                ...
                                <tbody>
                                    <tr v-for="item in carrito" v-bind:key="item.id">
                                        <td>
                                            <img 
                                                class="img-fluid" 
                            ...
                            <button @click="$emit('on-empty-cart')" class="btn btn-dark w-100 mt-3 p-2">Vaciar Carrito</button> 
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <div class="row mt-5">
                <div class="col-md-6 text-center text-md-start pt-5">
                    ...
                    <button 
                        ...
                        @click="$emit('on-add-to-cart', guitarraPrincipal)"
